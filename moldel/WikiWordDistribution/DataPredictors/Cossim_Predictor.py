...
class Cossim_Predictor(DataPredictor):
    def __init__(self, score_lowerbound, exponent, min_probability):
        ...
        Arguments:
            ...
            training data and for the predict data it gets the lowest probability of being the Mol.
            exponent (float): When the exponent is set higher then closer neighbours have a larger weight. If the
            value is set lower then the probabilities for the candidates of being the Mol are closer to each other.
            min_probability (float): The least possible probability of being the Mol. Candidates with a lower
            probability will have their probability increased to this value. """
